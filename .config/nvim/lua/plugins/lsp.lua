...
return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- Add any additional override configuration per server.
      ...
      -- stylua is a formatter managed by conform, not an LSP.
      -- nvim-lspconfig now ships lsp/stylua.lua (using --lsp) and mason-lspconfig
      -- enables it via the handler above. Disable it last so it sticks.
